...
addon_info = {
	...
	"addon_name": "mlrecorder",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("MLRecorder"),
	# Add-on description
	...
	"addon_url": "https://github.com/marcomolinaleija/addon-MLRecorder",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/marcomolinaleija/addon-MLRecorder",
	...
	"addon_licenseURL": "https://www.apache.org/licenses/LICENSE-2.0",
}
...
pythonSources = [
    'addon/globalPlugins/mlrecorder.py',
